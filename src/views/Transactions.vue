    ...
    <div class="row mt-1">
      ...
      <div class="row">
        <div class="search input-group ms-2">
          <span class="input-group-text bg-light rounded-0" id="basic-addon1"><i
              class="isax isax-search-status-1 fs-4"></i></span>
        ...
        <div class="col">
          <div class="input-group mb-3">
            ...
            <button type="button" class="filter-btn bg-white" aria-label="Selected-Field"
            ...
            <div class="col-md ms-3">
              <div class="col-md">
                <button type="button" class="button-hover-icon-purple">
                  <span class="position-absolute refund-request top-50 end-0 translate-middle-y me-4">Refund
                    Request</span>
                </button>
              </div>
            </div>
            ...
            <tbody>
              <template v-for="(transaction_record, index) in transaction_records" :key="transaction_record">
                <tr data-bs-toggle="collapse" :data-bs-target="`#collapse${index}`" aria-expanded="true"
                  :aria-controls="`collapse${index}`" class="title-8">
                  <td scope="row">
                  ...
                  <td>
                    <div class="btn py-0 rounded-0 title-16 w-100" :class="getStatus(transaction_record.status)">{{
