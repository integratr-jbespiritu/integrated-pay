      ...
      <div class="row gx-0 g-0 mt-3">
        ...
        <div class="col-9 col-md-5 d-flex align-items-end justify-content-start justify-content-md-end mb-2 mt-2 px-3">
          <router-link :to="{ name: 'consumer.request-refund' }">
            <button type="button"
              class="refund-border-purple btn title-5 bg-transparent rounded-0 text-purple border-2">Refund
              Request</button>
          </router-link>
        ...
        <div class="row gx-0 g-0">
          <form class="form-group modal-form">
            <div class="form-floating modal-floating">
              <select class="form-select modal-select rounded-0 title-21 shadow-none" id="floatingselect"
            ...
            <div class="form-floating modal-floating mb-3">
              <select class="form-select modal-select mt-3 rounded-0 title-21 shadow-none" id="floatingselect mt-5"
                aria-label="Floating label select">
            ...
            <div class="input-group mb-3">
              <form class="form-floating modal-floating">
                <input type="text" class="input-height form-control title-21 shadow-none" id="floatingInputValue"
                  placeholder="name@example.com" value="123456789012" />
            ...
            <div class="input-group mb-3">
              <form class="form-floating modal-floating">
                <input type="text" class="input-height form-control title-21 shadow-none" id="floatingInputValue"
                  placeholder="name@example.com" value="PHP 10,000.00" />
                <label for="floatingInputValue" class="title-23">Amount</label>
              </form>
            </div>
            <div class="input-group">
              <form class="form-floating modal-floating">
                <input type="text" class="input-height form-control title-21 shadow-none"
                  style="height: 100px; padding-bottom: 50px;" id="floatingInputValue" placeholder="name@example.com"
