<template>
   <div class="pad-x-10p pad-end-20p">
      <div class="row gx-0 g-0">
         ...
         <!-- <div class="row gx-0 pad-top-20p">
            ...
            <div class="col-12 col-md-4">
               <div class="input-group">
                  ...
                  <button type="button" class="btn filter-bar bg-white rounded-0 py-1 " aria-label="Selected-Field" aria-describedby="basic-addon2">Filter</button>
               </div>
            </div>
            <div class="col col-md-6 d-flex">
               ...
               <div>
                  <button type="button" class="title-5 button-default-outline pe-1 mx-2 mt-1 bg-transparent">Export</button>
               </div>
            </div>
            </div> -->
         <div class="row gx-0 g-0 mt-3">
            <div class="col-12 col-md-3 d-flex justify-content-start align-items-start ">
               <div class="search input-group mt-2 w-100 pe-4">
                  <span class="input-group-text bg-white rounded-0" id="basic-addon1">
                  <i class="isax isax-search-status-1 fs-4"></i>
                  </span>
            ...
            <div class="col-12 col-md-4">
               <div class="input-group mb-2 mt-2 ps-0 ps-md-0">
                  <span class="span-btn-default input-group-text rounded-0">
                  <i class="icon isax isax-filter-search"></i>
                  </span>
         ...
         <div class="table-responsive mt-2 margin-x-10p">
            <table class="table">
               <thead>
               ...
               <tbody>
                  <template v-for="(transaction_record,) in transaction_records" :key="transaction_record">
                     <tr  class="size-table-data column title-8 border-color-white">
                        <td class="py-3">
                           {{ transaction_record.transaction_no }}
                        </td>
                        <td class="py-3">{{ transaction_record.amount_refunded }}</td>
                        <td class="py-3">
                           <router-link :to="{name: 'consumer.view-transaction'}" class="text-decoration-none text-dark">{{ transaction_record.offer }}</router-link>
                        </td>
                        ...
                        <td class="py-3">
                           <div class="py-0 my-auto px-2 rounded-0 title-17 text-center" :class="getStatus(transaction_record.status)" style="width: 100px; height: 24px; padding: 1px, 8px, 1px, 8px;">{{
      ...
      <nav aria-label="Page navigation" class="ms-3">
         <ul class="pagination justify-content-end pe-3 me-1">
