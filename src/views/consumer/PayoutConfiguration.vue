            ...
            <div class="row gx-0 p-3 g-0 mx-3 py-2 mt-3 bg-white"
                ...
                <template v-for="(payout_configuration, j) in payout_configurations" :key="j">
                    <div class="col-12 title-4 d-flex align-items-center justify-content-between">
                        ...
                        <img i v-if="j === 0 || j === 2" src="/src/assets/images/chevron-down.svg" alt="" class="img-fluid fs-6 my-auto mx-4">
                    </div>
                    ...
                    <div class="row gx-0 g-0 input-border-hover justify-content-start">
                        <template v-for="(payment_method, i) in payout_configuration.mode_of_payments" :key="i">
                                ...
                                <div class="col-4 ps-3 pt-1" >
                                    ...
                                    <div class="form-check form-switch-btn mx-3 my-3">
                                        <input class="form-check-input fs-4" style="bottom: 5px;" type="checkbox"
                                            :id="'switch' + k + j" @change="payout_channel_modal = $event.target.checked" v-model="payout_method.is_accepted" />
                            ...
                            <div class="col-4 py-5 h-100 pe-5 d-flex justify-content-end">
                                <button type="button"
                                    class="btn bg-purple text-white rounded border border-white my-3 title-8" @click="update_payout_debit_modal=true">Update Payout
                                    Details</button>
                            </div>
                        </template>
                    </div>
        ...
        <ModalLayoutSmall :show="payout_channel_modal" @close="payout_channel_modal = false">
            <template #header>
                <div class="row gx-0 g-0 ps-5">
                    <div class="col ms-5">
                        <img src="/src/assets/images/popup-icon.svg" alt="Modal Figure" class="img-fluid" style="top: 15px; width: 130px;">
                    </div>
                    <div class="col d-flex justify-content-evenly align-items-end">
                        <button type="button" class="close-icon isax isax-close-circle5 border-0 bg-transparent" style="bottom:60px; left: 116px;" @click="payout_channel_modal = false" aria-label="Close"></button>
                    </div>
                </div>
            </template>
            <template #body>
            ...
            <template #footer>
                <div class="row gx-0 g-0 d-flex justify-content-center align-items-center" style="right: 33%;">
                    <div class="col mx-2">
                        <button type="button" class="btn btn-outline border-purple border-2 text-purple" @click="payout_channel_modal = false">Cancel</button>
                    </div>
                    <div class="col">
    ...
    <Teleport to="body">
        ...
        <template #header>
            <div class="row gx-0 g-0 lh-1">
                ...
                <div class="col-1 d-flex justify-content-end">
                    <button type="button" class="close-icon isax isax-close-circle5 border-0 bg-transparent ms-2" style=" bottom: 8px;" @click="update_payout_debit_modal = false" aria-label="Close"></button>
                </div>
            </div>
        </template>
        <template #body>
            <div class="row gx-0 g-0">
                ...
                <div class="input-group input-group-xl mb-3">
                    ...
                    <input type="text" class="floating-label-border form-control" placeholder="Upload a file" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" />
                </div>
                <div class="form-floating floating-label-color mb-3">
                    <select class="form-select floating-label-border rounded-0" id="floatingSelect" aria-label="Floating label select example">
                ...
                <form class="form-floating floating-label-color mb-3">
                    <input type="mobile number" class="form-control floating-label-border" id="floatingInputValue" placeholder="123456789012" value="123456789012">
                    <label for="floatingInputValue">Account Number</label>
                </form>
                <form class="form-floating floating-label-color mb-3">
                    <input type="name" class="form-control floating-label-border" id="floatingInputValue" placeholder="LGU of Lorem Ipsum" value="LGU of Lorem Ipsum">
                    <label for="floatingInputValue">Account Name</label>
                </form>
                <form class="form-floating floating-label-color">
                    <input type="text" class="form-control floating-label-border" id="floatingInputValue" value="Payment must be completed within 30 minutes.">
        ...
        <template #footer>
           <div class="row gx-0 g-0 d-flex justify-content-center align-items-center" style="right: 39%;">
                <div class="col mx-3">
                    <button type="button" class="btn btn-outline border-purple border-0 text-purple" @click="update_payout_debit_modal=false">Cancel</button>
                </div>
                <div class="col">
    ...
    <Teleport to="body">
            ...
            <template #header>
                <div class="row gx-0 g-0 lh-1">
                    ...
                    <div class="col-1 d-flex justify-content-end">
                        <button type="button" class="close-icon isax isax-close-circle5 border-0 bg-transparent ms-2    " style=" bottom: 8px;" @click="update_payout_e_wallet_modal = false" aria-label="Close"></button>
                    </div>
                </div>
            </template>
            <template #body>
                <div class="row gx-0 g-0">
                    ...
                    <form class="form-floating floating-label-color mb-3">
                        <input type="mobile number" class="form-control floating-label-border" id="floatingInputValue" placeholder="+639123456789" value="+639123456789">
                        <label for="floatingInputValue">Account Number</label>
                    </form>
                    <form class="form-floating floating-label-color mb-3">
                        <input type="name" class="form-control floating-label-border" id="floatingInputValue" placeholder="LGU of Lorem Ipsum" value="LGU of Lorem Ipsum">
            ...
            <template #footer>
               <div class="row gx-0 g-0 d-flex justify-content-center align-items-center" style="right: 39%;">
                    <div class="col mx-3">
                        <button type="button" class="btn btn-outline border-purple border-0 text-purple" @click="update_payout_e_wallet_modal = false">Cancel</button>
                    </div>
                    <div class="col">
                        <button type="button" class="btn bg-purple text-white border-2">Save</button>
                    </div>
