<template>
    <div class="row mx-3">
      <header class="header bg-light lh-1 mt-2">
          ...
          <div class="col">
            <div class="pb-3 me-3 px-1 bg-white">
              ...
              <div class="paymentMethods mx-2">
                <div class="title-4 px-3 pb-1">
                  Accepted Payment Methods
                </div>
                <div class="row gx-0 g-0 pt-3 px-3 pb-2">
                  <div class="col-12">
              ...
              <div class="table-responsive text-nowrap">
                <div class="pe-5 mx-4 mb-2 d-flex flex-column justify-content-between" style="min-width: 1000px;">
                <template v-for="payment_channel,j in payment_channels" :key="payment_channel">
                  ...
                  <template v-for="payment_method,i in payment_channel.mode_of_payments" :key="payment_method">
                     <div class="input-border row gx-0 g-0 mt-4 py-2 pe-5" style="min-width: 104.5%;">
