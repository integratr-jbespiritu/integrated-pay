        ...
        <div class="container pe-4">
            <div class="bor-style-solid m-auto">
                <header class="header bg-light lh-1">
                    <div class="col-12">
                        <a class="title-10 text-decoration-none text-dark" href="#">KYC</a>
                    </div>
                </header>
                <div class="row gx-0 g-0 ms-3 me-5">
                    ...
                    <div class="col-12 col-md-5 d-flex align-items-end justify-content-end pe-5 mb-2 mt-2">
                        <button type="button" class="bg-transparent py-0 h-100 border border-2 border-purple"
                            @click="refund_request_modal = true">
                            <span class="title-5 translate-middle-y text-nowrap mx-2">
                                Refund Request
                            </span>
                        </button>
                        <button type="button"
                            class="button-default-outline title-5 pe-2 bg-transparent mx-4 h-100">Export</button>
                    </div>
                </div>
                        ...
                        <tbody>
                            <template v-for="(transaction_record, index) in transaction_records" :key="transaction_record">
                                <tr data-bs-toggle="collapse" :data-bs-target="`#collapse${index}`" aria-expanded="true"
                                    ...
                                    <td class="font-table-text py-3 lh-xl pe-5">{{
                                        transaction_record.emailaddress }}</td>
                                    <td class="font-table-text py-3 lh-xl pe-9">{{ transaction_record.accountname }}</td>
                                    <td class="font-table-text py-3 lh-xl pe-4">{{ transaction_record.typeofAccount }}</td>
                                    <td class="font-table-text py-3 lh-xl pe-4">
                                        <div class="py-0 my-auto rounded-0 title-19 text-center px-3 ms-3 mt-1"
                                            :class="getStatus(transaction_record.status)">{{
                                                transaction_record.status }}</div>
                                    </td>
                                    <td class="font-table-text py-3 lh-xl pe-4">{{ transaction_record.time_stamp }}</td>
                                    <td class="font-table-text py-3 lh-xl">
                                        <div class="assess lh-lg">Assess
                                        </div>
                                    </td>
                                </tr>
                            </template>
    ...
    data() {
        return {
            transaction_records: [
                ...
                {
                    emailaddress: "jaydenlee@gmail.com",
                ...
                {
                    emailaddress: "mariaclara@gmail.com",
                ...
                },
                {
                    ...
                    accountname: "Mark Jose",
                    typeofAccount: "Business",
                    status: "Declined",
                    time_stamp: "01/01/2023 7:28 AM",
                },
                {
                    emailaddress: "karina@gmail.com",
                    accountname: "Karina Santos",
                    typeofAccount: "Business",
                    status: "Declined",
                    time_stamp: "01/01/2023 7:28 AM",
                },
                {
                    ...
                    accountname: "Thomas Gabriel",
                    typeofAccount: "Government Unit ",
                    status: "Declined",
                    time_stamp: "01/01/2023 7:28 AM",
                },
                {
                    emailaddress: "louis@gmail.com",
                    accountname: "Louis Reyes",
                    typeofAccount: "Government Unit",
                    status: "Approved",
                    time_stamp: "01/01/2023 7:28 AM",
                },
                {
                    emailaddress: "angel@gmail.com",
                    accountname: "Angel Cordova",
                    typeofAccount: "Government Unit",
                    status: "Pending",
                    time_stamp: "01/01/2023 7:28 AM",
                },
                {
                    emailaddress: "clarice@gmail.com",
                    accountname: "Clarice San Jose",
                    typeofAccount: "Government Unit",
                    status: "Pending",
                    time_stamp: "01/01/2023 7:28 AM",
                },
